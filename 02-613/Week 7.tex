...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[circle, thick, draw, red, minimum size=0.9cm] at (8, 2) (red1) {$x_l$};
        \node[circle, thick, draw, blue, minimum size=0.9cm] at (9, 1) (blue1) {$x_r$};
        \node[circle, thick, draw, green, minimum size=0.9cm] at (10, 0) (green1) {$P_r$};
