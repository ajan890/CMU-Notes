...
\begin{center}
\begin{tikzpicture}
    \node[draw, circle, label=above:{1, \textcolor{red}{11}}] at (0, 0) (A) {A};
    \node[draw, circle, label=above:{2, 8, \textcolor{red}{10}}] at (2, 2) (B) {B};
    \node[draw, circle, label=below:{\textcolor{red}{9}}] at (2, 0) (C) {C};
    \node[draw, circle, label=below:{3, 5, \textcolor{red}{7}}] at (4, 0) (D) {D};
    \node[draw, circle, label=above:{\textcolor{red}{4}}] at (6, 2) (E) {E};
    \node[draw, circle, label=below:{\textcolor{red}{6}}] at (6, 0) (F) {F};
    \draw[->] (A) edge (B);
    \draw[->] (B) edge (C);
    \draw[->] (A) edge (C);
    \draw[->] (B) edge (D);
