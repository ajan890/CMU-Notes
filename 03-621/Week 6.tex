...
\end{itemize}
Random mating (with respect to the gene of interest) is the key assumption of the Hardy-Weinberg principle.  What if mating is not random?
\begin{itemize}
	\item By themselves, departures from random mating \textbf{do not affect allele frequencies}, but they do \textbf{affect genotype frequencies}, changing them from the Hardy-Weinberg proportions.
	\item Can increase or decrease the efficiency of selection
	\item What will this depend on?
\end{itemize}
