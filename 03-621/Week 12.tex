...
\begin{itemize}
	\item Pros:
	\begin{itemize}
	    \item Detects TF footprints
	    \item Great sensitivity at promoters
    \end{itemize}
    \item Cons:
    \begin{itemize}
	    \item Time-consuming
	    \item DNase I sequence bias
    \end{itemize}
\end{itemize}
\textbf{ATAC-seq:}
\begin{itemize}
	\item Pros:
	\begin{itemize}
	    \item Simple, fast sample preparation
	    \item Low input
	    \item Detects TF footprints
	    \item Detects nucleosome occupancy
    \end{itemize}
    \item Cons:
    \begin{itemize}
	    \item Fresh tissue isolation
	    \item Mitochondrial DNA contamination
	    \item Sequence bias of Tn5 transposase
    \end{itemize}
\end{itemize}
